...
// Selection
//无选中返回nil，多行时返回非nil值为最小那个
@property (nonatomic, readonly, nullable) NSIndexPath *indexPathForSelectedRow; // returns nil or index path representing section and row of selection.返回nil或索引路径，表示选择的部分和行。
//无选中返回nil，最近点击排列数组最后
