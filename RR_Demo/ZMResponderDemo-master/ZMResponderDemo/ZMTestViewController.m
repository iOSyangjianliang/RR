...
//    ZMDrawingBoardView *view = [[ZMDrawingBoardView alloc] initWithFrame:CGRectMake(30, 100, 200, 400)];
//    view.backgroundColor = [UIColor purpleColor];
//    [self.view addSubview:view];
    
    ZMCustomInputView *view = [[ZMCustomInputView alloc] initWithFrame:CGRectMake(30, 100, 250, 400)];
    view.backgroundColor = [UIColor purpleColor];
    [self.view addSubview:view];

//    ZMKeyCommandView *view = [[ZMKeyCommandView alloc] initWithFrame:CGRectMake(30, 100, 200, 500)];
//    view.backgroundColor = [UIColor purpleColor];
//    [self.view addSubview:view];
